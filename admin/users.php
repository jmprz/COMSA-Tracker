...
<head>
    ...
    <style>
        ...
        .btn-active {
            ...
            /* A light blue shade for active state */
                    ...
                    <div class="card shadow-md border-0">
                        <div class="card-body">
                            <div
                                ...
                                <h2 class="fw-bold mb-0 text-dark">User
                                    Management</h2>
                            ...
                            <div class="row g-3 align-items-center mb-4">
                                ...
                                <div class="col-md-5">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="userFilterInput" class="form-control modern-input"
                                ...
                                <!-- Sorting -->
                                <div class="col-md-5">
                                    <form id="sortForm" class="d-flex gap-2" style="max-width:700px;" method="GET"
                                        action="users.php">

                                        <select name="sort" class="form-select modern-select">
                                            <option value="id" <?= $sort_field_param == 'id' ? 'selected' : '' ?>>ID
                                            </option>
                                            <option value="name" <?= $sort_field_param == 'name' ? 'selected' : '' ?>>Name
                                            </option>
                                            <option value="email" <?= $sort_field_param == 'email' ? 'selected' : '' ?>>
                                                Email</option>
                                            <option value="student_number" <?= $sort_field_param == 'student_number' ? 'selected' : '' ?>>Student No.</option>
                                            <option value="role" <?= $sort_field_param == 'role' ? 'selected' : '' ?>>Role
                                            </option>
                                        </select>

                                        <select name="dir" class="form-select modern-select" style="max-width:200px;">
                                            <option value="ASC" <?= $sort_dir == 'ASC' ? 'selected' : '' ?>>Ascending
                                            </option>
                                            <option value="DESC" <?= $sort_dir == 'DESC' ? 'selected' : '' ?>>Descending
                                            </option>
                                        </select>

                                        <button type="submit" class="btn btn-primary btn-modern-primary d-flex">
                                            <i class="ri-equalizer-line me-2"></i> Apply
                                        </button>
                                ...
                                <div class="col-md-2 text-md-end">
                                    <a href="users.php" class="btn btn-outline-secondary btn-modern-reset w-100">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group btn-group-sm" role="group">
                                                            <button class="btn btn-icon edit-user-btn text-primary"
                                                                ...
                                                                data-role="<?= $row['role'] ?>" data-type="<?= $row['type'] ?>">
                    ...
                    <div class="modal-content">
                        <form method="POST" action="../functions/save_user.php">
                            <div class="modal-header text-dark">
                                <h5 class="modal-title" id="addUserModalLabel"><i class="ri-user-add-line me-2"></i>
                                    Register New User</h5>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-comsa"><i class="ri-user-add-line me-1"></i>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form method="POST" action="../functions/update_user.php">
                            ...
                            <div class="modal-header text-dark">
                                <h5 class="modal-title" id="editUserModalLabel"><i class="ri-edit-line me-2"></i> Edit
                                    User Details</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Student Number</label>
                                    <input type="text" class="form-control" id="edit-user-student_number"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="edit-user-type" name="type"
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <form method="GET" action="../functions/delete_user.php">
                            ...
                            <div class="modal-header text-dark">
                                <h5 class="modal-title" id="deleteUserModalLabel"><i class="ri-alert-line me-2"></i>
                                    Confirm Delete</h5>
                                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
